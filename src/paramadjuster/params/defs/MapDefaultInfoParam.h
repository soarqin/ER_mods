...
struct MapDefaultInfoParam {
     ...
     * Default Value  = -1 */
    int8_t WeatherCreateAssetLimitId = -1;
     ...
     * Default Value  = -1 */
    int32_t MapAdditionalSoundBankId = -1;
     ...
     * Default Value  = 1 */
    uint8_t IsEnableBlendTimezoneEnvmap = 1;
     ...
     * Default Value  = -1 */
    int8_t OverrideGIResolution_XSS = -1;
     ...
     * Default Value  = 32400 */
    uint32_t MapAutoDrawGroupBackFacePixelNum = 32400;
     ...
     * Default Value  = 1 */
    uint8_t IsEnableTimezonnePlayerLigntScale = 1;
     ...
     * Default Value  = -1 */
    int16_t OpenChrActivateThreshold = -1;
     ...
     * Default Value  = -1 */
    int32_t MapMimicryEstablishmentParamId = -1;
     ...
     * Default Value  = -1 */
    int8_t OverrideGIResolution_XSX = -1;
