...
template<> void ParamTableIndexer<MenuCommonParam>::exportToCsvImpl(const std::wstring &csvPath) {
    ...
    fwprintf(f, L",worldMapCursorFirstDelay,worldMapCursorWaitTime,worldMapCursorSnapRadius,worldMapCursorSnapTime,itemGetLogAliveTime,playerMaxSaLimit,worldMap_IsChangeableLayerEventFlagId,worldMap_TravelMargin,systemAnnounceScrollBufferTime,systemAnnounceScrollSpeed,systemAnnounceNoScrollWaitTime,systemAnnounceScrollCount,compassMemoDispDistance,compassBonfireDispDistance,markerGoalThreshold,svSliderStep");
    fwprintf(f, L",preOpeningMovie_WaitSec,kgIconScale,kgIconScale_forTable,kgIconVspace_forTable,kgIconScale_forConfig,kgIconVspace_forConfig,worldMap_SearchRadius,tutorialDisplayTime,compassFriendHostInnerDistance,compassEnemyHostInnerDistance,compassFriendGuestInnerDistance,cutsceneKeyGuideAliveTime,autoHideHpThresholdRatio,autoHideHpThresholdValue,autoHideMpThresholdRatio,autoHideMpThresholdValue");
    fwprintf(f, L",autoHideSpThresholdRatio,autoHideSpThresholdValue,worldMapZoomAnimationTime,worldMapIconScaleMin,worldMap_TravelMargin_Point,enemyTagSafeLeft,enemyTagSafeRight,enemyTagSafeTop,enemyTagSafeBottom,pcHorseHpRecoverDispThreshold,worldMap_DlcLayerEventFlagId,unknown_0xe4,unknown_0xe5,unknown_0xe6,unknown_0xe7,unknown_0xe8");
    fwprintf(f, L",unknown_0xe9,unknown_0xea,unknown_0xeb,unknown_0xec,unknown_0xed,unknown_0xee\n");
    auto cnt = this->count();
    for (int i = 0; i < cnt; i++) {
