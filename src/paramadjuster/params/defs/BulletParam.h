...
struct BulletParam {
     ...
     * Default Value  = -1 */
    int32_t spEffectIDForShooter = -1;
     ...
     * Default Value  = 254 */
    uint8_t Material_AttackType = 254;
     ...
     * Default Value  = 254 */
    uint8_t Material_AttackMaterial = 254;
     ...
     * Default Value  = -1 */
    int32_t intervalCreateBulletId = -1;
    ...
    /* pad
     * Disable AI Projectile Dodge
     *   If ON, this projectile will not be dodged by the AI. */
    uint8_t isDisableAiProjectileDodge:1 {};
     ...
     * Default Value  = -1 */
    int16_t followDmypoly_forSfxPose = -1;
