...
struct GrassTypeParam {
     ...
     * Width Scale - Min
     * Default Value  = 100 */
    uint8_t scaleBaseMin = 100;

    /* 幅のスケール範囲(max，％)
     * Width Scale - Max
     * Default Value  = 100 */
    uint8_t scaleBaseMax = 100;

    /* 高さのスケール範囲(min，％)
     * Height Scale - Min
     * Default Value  = 100 */
    uint8_t scaleHeightMin = 100;

    /* 高さのスケール範囲(max，％)
     * Height Scale - Max
     * Default Value  = 100 */
    uint8_t scaleHeightMax = 100;

    /* 乗算カラー１ (赤）
     * Color Shade [1] R
     * Default Value  = 255 */
    uint8_t colorShade1_r = 255;

    /* 乗算カラー１ （緑）
     * Color Shade [1] G
     * Default Value  = 255 */
    uint8_t colorShade1_g = 255;

    /* 乗算カラー １（青）
     * Color Shade [1] B
     * Default Value  = 255 */
    uint8_t colorShade1_b = 255;

    /* 乗算カラー２ （赤）
     * Color Shade [2] R
     * Default Value  = 255 */
    uint8_t colorShade2_r = 255;

    /* 乗算カラー２ （緑）
     * Color Shade [2] G
     * Default Value  = 255 */
    uint8_t colorShade2_g = 255;

    /* 乗算カラー ２（青）
     * Color Shade [2] B
     * Default Value  = 255 */
    uint8_t colorShade2_b = 255;
