...
struct WeatherParam {
     ...
     * Default Value  = 3600 */
    uint32_t NextLotIngameSecondsMin = 3600;
     ...
     * Default Value  = 7200 */
    uint32_t NextLotIngameSecondsMax = 7200;
