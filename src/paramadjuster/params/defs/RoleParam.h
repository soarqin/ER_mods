...
struct RoleParam {
     ...
     * Default Value  = -1 */
    int32_t phantomParamId_vowRank1 = -1;
     ...
     * Default Value  = -1 */
    int32_t phantomParamId_vowRank2 = -1;
     ...
     * Default Value  = -1 */
    int32_t phantomParamId_vowRank3 = -1;
