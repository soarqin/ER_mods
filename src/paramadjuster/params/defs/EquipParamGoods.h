...
struct EquipParamGoods {
     ...
     * Default Value  = -1 */
    int32_t appearanceReplaceItemId = -1;
     ...
     * Default Value  = -1 */
    int32_t yesNoDialogMessageId = -1;
     ...
     * Default Value  = 1 */
    uint8_t isUseNoAttackRegion:1 = 1;
