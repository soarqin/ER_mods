...
struct NpcParam {
     ...
     * Default Value  = -1 */
    int32_t resistCorrectId_poison = -1;
     ...
     * Default Value  = -1 */
    int16_t normalChangeResouceId = -1;
     ...
     * Default Value  = -1 */
    int16_t normalChangeTexChrId = -1;
     ...
     * Default Value  = 12 */
    uint8_t pushOutCamRegionRadius = 12;
     ...
     * Default Value  = 15 */
    uint8_t ladderEndChkOffsetTop = 15;
     ...
     * Default Value  = 8 */
    uint8_t ladderEndChkOffsetLow = 8;
     ...
     * Default Value  = -1 */
    int16_t normalChangeAnimChrId = -1;
     ...
     * Default Value  = 256 */
    uint16_t paintRenderTargetSize = 256;
     ...
     *   When the abnormal condition is activated, the maximum value is temporarily changed by using the set value of the abnormal condition resistance correction parameter.
     * Default Value  = -1 */
    int32_t resistCorrectId_disease = -1;
     ...
     * Default Value  = -1 */
    int32_t multiPlayCorrectionParamId = -1;
     ...
     * Default Value  = 1 */
    uint8_t enableAILockDmyPoly_212:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t enableAILockDmyPoly_213:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t enableAILockDmyPoly_214:1 = 1;
     ...
     * Default Value  = -1 */
    int16_t estusFlaskRecoveryParamId = -1;
     ...
     * Default Value  = -1 */
    int32_t WanderGhostPhantomId = -1;
     ...
     * Default Value  = -1 */
    int16_t RetargetReferenceChrId = -1;
     ...
     * Default Value  = -1 */
    int32_t overlapCameraDmypolyId = -1;
     ...
     * Default Value  = -1 */
    int32_t residentMaterialExParamId00 = -1;
     ...
     * Default Value  = -1 */
    int32_t residentMaterialExParamId01 = -1;
     ...
     * Default Value  = -1 */
    int32_t residentMaterialExParamId02 = -1;
     ...
     * Default Value  = -1 */
    int32_t residentMaterialExParamId03 = -1;
     ...
     * Default Value  = -1 */
    int32_t residentMaterialExParamId04 = -1;
     ...
     * Default Value  = -1 */
    int32_t sleepCollectorItemLotId_enemy = -1;
     ...
     * Default Value  = -1 */
    int32_t sleepCollectorItemLotId_map = -1;
     ...
     * Default Value  = -1 */
    int32_t resistCorrectId_blood = -1;

    /* 呪耐性 補正ルールID
     *   状態異常の発動時、状態異常耐性補正パラメータの設定値を使って、一時的に最大値を変動させる
     * Resist Correction - Death Blight
     *   When the abnormal condition is activated, the maximum value is temporarily changed by using the set value of the abnormal condition resistance correction parameter.
     * Default Value  = -1 */
    int32_t resistCorrectId_curse = -1;
     ...
     *   When the abnormal condition is activated, the maximum value is temporarily changed by using the setting value of the abnormal condition resistance correction parameter.
     * Default Value  = -1 */
    int32_t resistCorrectId_freeze = -1;
     ...
     *   When the abnormal condition is activated, the maximum value is temporarily changed by using the set value of the abnormal condition resistance correction parameter.
     * Default Value  = -1 */
    int32_t resistCorrectId_sleep = -1;
     ...
     *   When the abnormal condition is activated, the maximum value is temporarily changed by using the set value of the abnormal condition resistance correction parameter.
     * Default Value  = -1 */
    int32_t resistCorrectId_madness = -1;
    ...
    int32_t dlcGameClearSpEffectID {};
