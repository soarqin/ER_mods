...
struct PlayRegionParam {
     ...
     * Default Value  = -1 */
    int16_t cultNpcWhiteGhostEntityId_byFree = -1;
     ...
     * Default Value  = 1 */
    uint8_t multiPlayStartLimitEventFlagId_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t breakInLimitEventFlagId_1_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t whiteSignLimitEventFlagId_1_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t redSignLimitEventFlagId_1_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t breakInLimitEventFlagId_2_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t breakInLimitEventFlagId_3_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t whiteSignLimitEventFlagId_2_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t enableBloodMessage:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t whiteSignLimitEventFlagId_3_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t redSignLimitEventFlagId_2_targetFlagState:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t redSignLimitEventFlagId_3_targetFlagState:1 = 1;
