...
struct BonfireWarpParam {
     ...
     * Default Value  = -1 */
    int32_t bonfireSubCategoryId = -1;
     ...
     * Default Value  = -1 */
    int32_t noIgnitionSfxDmypolyId_0 = -1;
     ...
     *   Damipoli ID that issues SFX before bonfire ignition
     * Default Value  = -1 */
    int32_t noIgnitionSfxDmypolyId_1 = -1;
