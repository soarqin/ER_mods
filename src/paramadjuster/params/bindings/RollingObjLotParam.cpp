...
template<> void ParamTableIndexer<RollingObjLotParam>::exportToCsvImpl(const std::wstring &csvPath) {
    ...
    fwprintf(f, L"ID,disableParam_NT,AssetId_0,AssetId_1,AssetId_2,AssetId_3,AssetId_4,AssetId_5,AssetId_6,AssetId_7,CreateWeight_0,CreateWeight_1,CreateWeight_2,CreateWeight_3,CreateWeight_4,CreateWeight_5");
    fwprintf(f, L",CreateWeight_6,CreateWeight_7\n");
    auto cnt = this->count();
    for (int i = 0; i < cnt; i++) {
