...
struct ChrActivateConditionParam {
     ...
     * Default Value  = 1 */
    uint8_t weatherStormForBattle:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t weatherHeavyFogRain:1 = 1;
