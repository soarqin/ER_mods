...
struct PlayerCommonParam {
     ...
     * Default Value  = -1 */
    int32_t flareOverrideHomingAngle = -1;
     ...
     * Default Value  = 1 */
    uint16_t unlockEventFlagStepNum_forWepAttr = 1;
     ...
     * Default Value  = -1 */
    int32_t retributionMagic_burstMagicParamId = -1;
     ...
     * Default Value  = -1 */
    int32_t resistCurseItemSpEffectBaseId = -1;
     ...
     * Default Value  = -1 */
    int32_t resistCurseItemLotParamId_map = -1;
