...
struct MagicParam {
     ...
     * Default Value  = -1 */
    int32_t limitCancelSpEffectId = -1;
     ...
     * Default Value  = -1 */
    int16_t consumeLoopMP_forMenu = -1;
