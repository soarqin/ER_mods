...
template<> void ParamTableIndexer<CharaInitParam>::exportToCsvImpl(const std::wstring &csvPath) {
    ...
    fwprintf(f, L"ID,baseRec_mp,baseRec_sp,red_Falldam,soul,equip_Wep_Right,equip_Subwep_Right,equip_Wep_Left,equip_Subwep_Left,equip_Helm,equip_Armer,equip_Gaunt,equip_Leg,equip_Arrow,equip_Bolt,equip_SubArrow");
    fwprintf(f, L",equip_SubBolt,equip_Accessory01,equip_Accessory02,equip_Accessory03,equip_Accessory04,unknown_0x50,unknown_0x51,elixir_material00,elixir_material01,elixir_material02,equip_Spell_01,equip_Spell_02,equip_Spell_03,equip_Spell_04,equip_Spell_05,equip_Spell_06");
    fwprintf(f, L",equip_Spell_07,item_01,item_02,item_03,item_04,item_05,item_06,item_07,item_08,item_09,item_10,npcPlayerFaceGenId,npcPlayerThinkId,baseHp,baseMp,baseSp");
    fwprintf(f, L",arrowNum,boltNum,subArrowNum,subBoltNum,soulLv,baseVit,baseWil,baseEnd,baseStr,baseDex,baseMag,baseFai,baseLuc,baseHeroPoint,baseDurability,itemNum_01");
    fwprintf(f, L",itemNum_02,itemNum_03,itemNum_04,itemNum_05,itemNum_06,itemNum_07,itemNum_08,itemNum_09,itemNum_10,gestureId0,gestureId1,gestureId2,gestureId3,gestureId4,gestureId5,gestureId6");
    fwprintf(f, L",npcPlayerType,npcPlayerDrawType,npcPlayerSex,vowType,isSyncTarget,wepParamType_Right1,wepParamType_Right2,wepParamType_Right3,wepParamType_Left1,wepParamType_Left2,wepParamType_Left3,equip_Subwep_Right3,equip_Subwep_Left3,secondaryItem_01,secondaryItem_02,secondaryItem_03");
    fwprintf(f, L",secondaryItem_04,secondaryItem_05,secondaryItem_06,secondaryItemNum_01,secondaryItemNum_02,secondaryItemNum_03,secondaryItemNum_04,secondaryItemNum_05,secondaryItemNum_06,HpEstMax,MpEstMax,voiceType\n");
    auto cnt = this->count();
    for (int i = 0; i < cnt; i++) {
