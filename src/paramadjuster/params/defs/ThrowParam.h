...
struct ThrowParam {
     ...
     * Default Value  = 80 */
    uint16_t sphereCastRadiusRateTop = 80;
     ...
     * Default Value  = 80 */
    uint16_t sphereCastRadiusRateLow = 80;
     ...
     * Default Value  = 1 */
    uint8_t isEnableCorrectPos_forThrowAdjust:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t isEnableThrowFollowingFallAssist:1 = 1;
     ...
     * Default Value  = 1 */
    uint8_t isEnableThrowFollowingFeedback:1 = 1;
     ...
     * Default Value  = -1 */
    int32_t judgeRangeBasePosDmyId1 = -1;
     ...
     *   Damipoli that the thrower considers to be his position when calculating the throw range. If -1, the capsule origin
     * Default Value  = -1 */
    int32_t judgeRangeBasePosDmyId2 = -1;
