...
struct EquipParamWeapon {
     ...
     * Default Value  = 100 */
    uint16_t attackBasePhysics = 100;
     ...
     * Default Value  = 100 */
    uint16_t attackBaseThunder = 100;
     ...
     * Default Value  = 100 */
    uint16_t attackBaseStamina = 100;
     ...
     * Max Correction: Blood Loss Guard Absorption
     ...
     * Max Correction: Death Blight Guard Absorption
     ...
     * Default Value  = -1 */
    int32_t attainmentWepStatusStr = -1;
     ...
     *   To change the R2 attack into a special action when the status is X or higher when using a specific weapon.
     * Default Value  = -1 */
    int32_t attainmentWepStatusDex = -1;
     ...
     *   To change the R2 attack into a special action when the status is X or higher when using a specific weapon.
     * Default Value  = -1 */
    int32_t attainmentWepStatusMag = -1;
     ...
     * Default Value  = -1 */
    int32_t attainmentWepStatusFai = -1;
     ...
     *   This is to change the R2 attack into a special action when the status is X or higher when using a specific weapon.
     * Default Value  = -1 */
    int32_t attainmentWepStatusLuc = -1;
     ...
     * Default Value  = 1 */
    uint8_t isSoulParamIdChange_model0:1 = 1;
     ...
     *   Whether the vfx parameter Soul Param ID for Weapon Enchantment and Invisible Weapon for Weapon Enchantment settings are applied
     * Default Value  = 1 */
    uint8_t isSoulParamIdChange_model1:1 = 1;
     ...
     *   Whether the vfx parameter Soul Param ID for Weapon Enchantment and Invisible Weapon for Weapon Enchantment settings are applied
     * Default Value  = 1 */
    uint8_t isSoulParamIdChange_model2:1 = 1;
     ...
     *   Whether the vfx parameter Soul Param ID for Weapon Enchantment and Invisible Weapon for Weapon Enchantment settings are applied
     * Default Value  = 1 */
    uint8_t isSoulParamIdChange_model3:1 = 1;
    ...
    uint8_t restrictSpecialSwordArt {};
