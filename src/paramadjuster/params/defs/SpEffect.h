...
struct SpEffect {
     ...
     * Default Value  = -1 */
    int32_t cycleOccurrenceSpEffectId = -1;
     ...
     * Default Value  = -1 */
    int32_t atkOccurrenceSpEffectId = -1;
     ...
     * Default Value  = -1 */
    int8_t addBehaviorJudgeId_condition = -1;
     ...
     * Default Value  = -1 */
    int8_t teamOffenseEffectivity = -1;
     ...
     * Default Value  = -1 */
    int32_t antiDarkSightDmypolyId = -1;
     ...
     * Default Value  = -1 */
    int16_t effectEndDeleteDecalGroupId = -1;
