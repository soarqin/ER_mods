...
struct MenuCommonParam {
     ...
     * Default Value  = 100 */
    int32_t systemAnnounceScrollSpeed = 100;
     ...
     * Default Value  = 1 */
    uint8_t systemAnnounceScrollCount = 1;
     ...
     * Default Value  = -1 */
    int32_t autoHideHpThresholdValue = -1;
     ...
     * Default Value  = -1 */
    int32_t autoHideMpThresholdValue = -1;
     ...
     * Default Value  = -1 */
    int32_t autoHideSpThresholdValue = -1;
     ...
     * Default Value  = 1920 */
    uint16_t enemyTagSafeRight = 1920;
     ...
     * Default Value  = 1080 */
    uint16_t enemyTagSafeBottom = 1080;
    ...
    /* World Map - DLC Layer Event Flag ID
     *   The event flag that must be ON for the DLC world map to be displayed. */
    uint32_t worldMap_DlcLayerEventFlagId {};

    uint8_t unknown_0xe4 {};

    uint8_t unknown_0xe5 {};

    uint8_t unknown_0xe6 {};

    uint8_t unknown_0xe7 {};

    uint8_t unknown_0xe8 {};

    uint8_t unknown_0xe9 {};

    uint8_t unknown_0xea {};

    uint8_t unknown_0xeb {};

    uint8_t unknown_0xec {};

    uint8_t unknown_0xed {};

    uint8_t unknown_0xee {};
